...
[[LoadingDataTargetingEntities]]<<LoadingDataTargetingEntities,Loading Data Targeting Entities>>
====
...
.[[ServerTargetingReturnValuesIntoAppState]]<<ServerTargetingReturnValuesIntoAppState,Server Targeting Return Values into App State>>
====

++++
<button class="inspector" onClick="book.main.focus('server_targeting_return_values_into_app_state')">Focus Inspector</button>
<div class="short narrow example" id="server_targeting_return_values_into_app_state"></div>
<br/>
++++
...
.[[ServerQuerySecurityExample]]<<ServerQuerySecurityExample,Server Query Security Example>>
====
